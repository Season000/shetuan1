...
<html>
  <head>
	...
	<STYLE type=text/css>
		BODY {PADDING-RIGHT: 0px; PADDING-LEFT: 2px; PADDING-BOTTOM: 0px; MARGIN: 0px; PADDING-TOP: 0px; BACKGROUND-COLOR: #000000}
		BODY {FONT-SIZE: 11px; COLOR: #000000; FONT-FAMILY: Verdana}
		TD {FONT-SIZE: 11px; COLOR: #CFB53B; FONT-FAMILY: Verdana}
		...
		A.style2:link {PADDING-LEFT: 2px; COLOR: #CFB53B; TEXT-DECORATION: none;font-family: 楷体;font-size: 24px;}
		A.style2:visited {PADDING-LEFT: 2px; COLOR: #CFB53B; TEXT-DECORATION: none;font-family: 楷体;font-size: 24px;}
		A.style2:hover {PADDING-LEFT: 2px; COLOR: #CFB53B; TEXT-DECORATION: none;font-family: 楷体;font-size: 24px;}
		A.active {PADDING-LEFT: 2px; COLOR: #CFB53B; TEXT-DECORATION: none;font-family: 楷体;font-size: 14px;}
  ...
  <TR>
    ...
    <TD vAlign=top width=180 bgColor=#ffffff>
      <TABLE cellSpacing=0 cellPadding=3 width=165 align=center border=0>
        ...
        <TR>
          <TD>
            <TABLE cellSpacing=0 cellPadding=20 width=250 align=center border=0>
        ...
        <TR>
          <TD>
          <TABLE cellSpacing=0 cellPadding=20 width=250 align=center border=0>
              <TR><TD class=menuSmall><A class=style2 onclick="logout()" target=dmMain style="font-family: 楷体;font-size: 24px;">安全退出系统</A></TD></TR>
			</TABLE>
		  </TD>
		</TR>
        <TR><TD background=<%=path %>/img/new_027.jpg height=1></TD></TR><TR>  
