...
<html>
  <head>
	...
	<STYLE type=text/css>
		BODY {PADDING-RIGHT: 0px; PADDING-LEFT: 0px; PADDING-BOTTOM: 0px; MARGIN: 0px; PADDING-TOP: 0px; BACKGROUND-COLOR: #000000}
		BODY {FONT-SIZE: 12px; COLOR: #003366; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif}
		TD {FONT-SIZE: 12px; COLOR: #FFFF00; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif}
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  <TR>
    <TD width=10></TD>
    <TD align=center background=><FONT size=5><B>高校社团信息管理系统</B></FONT> </TD>
    <TD>
	      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
